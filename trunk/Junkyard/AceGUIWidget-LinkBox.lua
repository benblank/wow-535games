...
do
	...
	local function EditBox_InsertLink(this, link)
		if (not link) then
			return false
		end
	...
	local function EditBox_OnEditFocusGained(this)
		AceHook:RawHook("ChatEdit_InsertLink", function(link) return EditBox_InsertLink(this, link) end, true)
	end
	
	local function EditBox_OnEditFocusLost(this)
		AceHook:Unhook("ChatEdit_InsertLink")
	end
	...
	local function Constructor()
		...
		local editbox = CreateFrame("EditBox","AceGUI-3.0LinkBox"..num,frame,"InputBoxTemplate")
